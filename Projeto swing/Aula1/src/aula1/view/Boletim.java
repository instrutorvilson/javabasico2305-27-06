...
public class Boletim extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        float n1 = Float.parseFloat(jTNota1.getText());        
        float n2 = Float.parseFloat(jTNota2.getText());
        float n3 = Float.parseFloat(jTNota3.getText());
        float frequencia = Float.parseFloat(jTFrequencia.getText());
        
        float media = (n1 + n2 + n3)/3;
       /* String msg = nome + " " + media;
       ...
       //preencher tabela
        ...
        modelo.addRow(new Object[]{nome,media,situacao});
